...
public class RaynorProduct {

	@Test(dataProvider = "test")
	public void Valiadate_the_Width(String date,String model, String quantity, String width, String height, String winndowQuntity,
			String additionalcable, String additionalcable2, String additionalcable3,
...
//			Thread.sleep(2000);
		...
		wait.until(
				ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//li[contains(text(),"+"'"+model+"'"+")]"))))
...
//		driver.findElement(By.xpath("(//input[@type='text'])[6]")).sendKeys(logoHeight, Keys.TAB, logoHeight, Keys.TAB,
//				logoHeight, Keys.TAB, logoHeight, Keys.TAB, logoHeight, Keys.TAB, logoHeight);

//CONTROL PANEL dropdown

//		driver.findElement(By.xpath("(//div[@aria-haspopup='listbox'])[35]")).click();
//
//		Thread.sleep(1000);
//
...
//DOOR NUMBER ###) field
		...
		List<WebElement> countbox = driver.findElements(By.xpath("//table/tbody/tr"));
...
//		
//		
//		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//div[@aria-haspopup='listbox'])[1]"))).click();
...
//
//		Set<String> listids = driver.getWindowHandles();
//
//		WebElement widthField = driver.findElement(By.xpath("//input[@placeholder='36 - 144 Inches']"));
//
//		Thread.sleep(2000);
//
//		widthField.sendKeys(Keys. + "a");
//		widthField.sendKeys(Keys.DELETE);
//
//		Thread.sleep(1000);
//		widthField.sendKeys(data);
//
//		Thread.sleep(2000);
//
...
//					
//					System.out.println("we are eneter ");
//				}
//				
//			}}
